...
const AdminLayout = () => {
 ...
 <div className={`lg:hidden fixed inset-y-0 left-0 z-50 w-64 bg-[#f4f5f7] transition-transform duration-300 ease-in-out ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
 <AdminSidebar {...sidebarProps} />
 </div>
 {sidebarOpen && (
 <div
 ...
 homeLabel="Autonex"
 homeIcon={<img src="/favicon.png" alt="" className="h-[18px] w-[18px] rounded-[5px] border border-slate-200 bg-white p-0.5" />}
 />
 </div>
