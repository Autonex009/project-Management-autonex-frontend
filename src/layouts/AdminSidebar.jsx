...
const rowActive = 'bg-white text-slate-900 font-semibold ring-1 ring-slate-200/60 shadow-[0_1px_2px_rgba(16,24,40,0.04)] ';
const rowInactive = 'text-slate-600 font-medium hover:text-slate-900 hover:bg-white/70 ';
...
const AdminSidebar = ({ user = {}, pendingSignupCount = 0, onNavigate, onLogout }) => {
 ...
 {isActive && <span className="absolute left-0 top-1/2 -translate-y-1/2 h-4 w-[3px] rounded-full bg-blue-600 " />}
 ...
 <p className="text-[12px] text-slate-400 truncate leading-tight">Admin Control Center</p>
 </div>
 </div>
 </div>
