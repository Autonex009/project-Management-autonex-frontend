      ...
      >
        ...
        <div className="flex items-start justify-between border-b border-slate-100 px-6 py-5">
          <div className="flex items-center gap-3">
            <div
              className={`flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full ${styles.iconWrap}`}
            >
            ...
            <dl className="mt-4 space-y-2 rounded-xl bg-slate-50 p-4">
              {details.map((row) => (
                ...
                >
                  ...
                  <dd
                    className={`font-semibold ${row.highlight ? "text-rose-600" : "text-slate-800"}`}
                  >
                    {row.value}
                  </dd>
                </div>
