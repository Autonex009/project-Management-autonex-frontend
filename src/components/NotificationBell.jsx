            ...
            {notifications.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-16 px-4 text-center text-slate-400">
                ...
                <p className="text-xs text-slate-500 mt-1 max-w-[200px] leading-relaxed">
                  We'll notify you here when leaves are requested, approved, or
                  changed.
                </p>
              </div>
            ) : (
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-start justify-between gap-2">
                        <p
                          className={`text-xs leading-snug break-words ${!n.is_read ? "font-bold text-slate-800" : "font-medium text-slate-600"}`}
                        >
                          {n.title}
                        </p>
                        {!n.is_read && (
