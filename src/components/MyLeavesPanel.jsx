...
import { Calendar, Plus, X, CheckCircle, XCircle, Clock, Home, AlertTriangle, Pencil, Trash2, HeartPulse, Star } from 'lucide-react';
...
const MyLeavesPanel = ({
 ...
 activeTab === tab ? 'bg-white text-slate-900 shadow-sm ring-1 ring-slate-200/70' : 'text-slate-500 hover:text-slate-800'
 }`}>
