...
export const PERF_PARAMETERS = [
  {
    ...
    description:
      "Consistently delivers accurate, thorough, and high-quality work.",
  },
  {
    name: "Productivity & Efficiency",
    description:
      "Completes assigned tasks on time and effectively manages workload.",
  },
  {
    name: "Communication Skills",
    description:
      "Communicates clearly, professionally, and keeps relevant stakeholders informed.",
  },
  {
    name: "Teamwork & Collaboration",
    description:
      "Works well with colleagues, contributes positively, and supports others when needed.",
  },
  {
    name: "Initiative & Problem Solving",
    description:
      "Demonstrates ownership, proactively identifies issues, and proposes effective solutions.",
  },
];
...
export const normalizeParamValues = (parameterValues = []) => {
  const byName = new Map(
    (parameterValues || []).map((p) => [p?.name, p || {}]),
  );
