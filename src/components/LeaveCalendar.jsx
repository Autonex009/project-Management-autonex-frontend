...
export default function LeaveCalendar({ filterEmployeeIds = null }) {
  ...
  const isFloaterInvalid =
    isFloaterType &&
    (selectedStart !== selectedEnd || !isValidFloaterDate(selectedStart));
  ...
  if (
    ...
    while (searching) {
      ...
      if (
        adjacentBefore >= 5 ||
        (new Date(selectedStart + "T00:00:00") - cur) / (1000 * 60 * 60 * 24) >
          15
      ) {
        searching = false;
      }
    ...
    while (searching) {
      ...
      if (
        adjacentAfter >= 5 ||
        (cur - new Date(selectedEnd + "T00:00:00")) / (1000 * 60 * 60 * 24) > 15
      ) {
        searching = false;
      }
    }
            ...
            >
              {cells.map((day, idx) => {
                ...
                const isSelectedStart =
                  selectedStart && dateStr === selectedStart;
            ...
            >
              ...
              <div style={{ marginBottom: "16px" }}>
                ...
                <textarea
                  ...
                  onBlur={(e) =>
                    (e.target.style.borderColor = sidebarTheme.inputBorder)
                  }
                />
              </div>
