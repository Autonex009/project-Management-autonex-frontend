...
import { Briefcase, Clock3, FolderKanban, Mail, Phone, Users, X, Search } from 'lucide-react';
...
const MyTeamPage = () => {
 ...
 <StatCard title="Team Members" value={teamMembers.length} icon={Users} tone="indigo" hint="in your scope" />
 <StatCard title="Scoped Projects" value={scopedProjects.length} icon={FolderKanban} tone="sky" hint="allocated to you" />
 <StatCard title="Total Daily Hours" value={teamMembers.reduce((sum, member) => sum + member.totalDailyHours, 0)} unit="h" icon={Clock3} tone="amber" hint="across the team" />
 </div>
