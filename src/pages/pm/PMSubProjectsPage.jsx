        ...
        columns={[
          {
            ...
            render: (value, project) => {
              const parent = scopedProjects.find(
                (item) => item.id === project.main_project_id,
              );
              return (
                <div>
                  <div className="font-semibold text-slate-800">{value}</div>
                  <div className="text-xs text-slate-400 mt-1">
                    {project.client || parent?.project_type || "Sub-project"}
                  </div>
                </div>
              );
            },
          ...
          },
          {
            ...
            align: "center",
            render: (value) => (
              <span className="text-slate-700">{value || 0}</span>
            ),
          },
          {
            key: "start_date",
