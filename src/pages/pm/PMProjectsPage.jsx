...
const getProjectTypeBadge = (projectType) => {
  ...
  return (
    styles[projectType] || "bg-slate-100 text-slate-600 border border-slate-200"
  );
};
      ...
      {scopedProjects.length === 0 ? (
        <div className="bg-white rounded-2xl border border-slate-200 p-12 text-center">
          ...
          <p className="text-slate-500">
            Projects linked to your PM account will appear here.
          </p>
        </div>
      ) : (
            ...
            >
              <div className="flex items-start justify-between mb-4">
                ...
                <div className="flex flex-col items-end gap-2">
                  <span
                    className={`px-2 py-1 rounded-full text-xs font-semibold ${getProjectTypeBadge(project.project_type)}`}
                  >
              ...
              <div className="grid grid-cols-2 gap-3 mb-4">
                ...
                <div className="bg-slate-50 rounded-lg p-3">
                  ...
                  <p className="text-sm font-semibold text-slate-900">
                    {project.global_start_date
                      ? format(new Date(project.global_start_date), "MMM yyyy")
                      : "-"}
                  </p>
                </div>
              </div>
