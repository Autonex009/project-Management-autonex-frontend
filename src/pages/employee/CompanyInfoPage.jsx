...
import { Send, Calendar, Building2, ShieldCheck, Sparkles, MapPin, Wifi, Copy, Check, Globe, Cpu, Bot, Layers, LogOut, AlertTriangle, Linkedin, Youtube, TrendingUp } from 'lucide-react';
...
const CompanyInfoPage = () => {
 ...
 <StatCard title="Annual Paid Leave (APL)" value="12" unit="Days" icon={Calendar} tone="emerald" hint="Granted per calendar year" />
 <StatCard title="National Holidays" value="8" unit="Days" icon={Sparkles} tone="indigo" hint="Fixed cultural & religious days" />
 <StatCard title="Floater Leave" value="2" unit="Days" icon={Globe} tone="amber" hint="For personal observances" />
 <StatCard title="Earned Leave Accrual" value="1 / 20" icon={TrendingUp} tone="rose" hint="1 day per 20 completed workdays" />
 </div>
 </div>
 ...
 <h4 className="font-bold text-indigo-800 text-sm">Working Hours & Weekend Support 🕒</h4>
