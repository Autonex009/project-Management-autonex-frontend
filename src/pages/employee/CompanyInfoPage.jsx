    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="bg-gradient-to-br from-amber-50/70 to-orange-50/40 border border-amber-100/60 rounded-2xl p-6 flex items-center gap-5">
          ...
          <p className="text-sm text-slate-600 leading-relaxed">
            <strong className="text-slate-800">Interns</strong> are required to
            serve a{" "}
            <strong className="text-slate-800">14-day notice period</strong>{" "}
            upon submitting their resignation.
          </p>
        </div>
        <div className="bg-gradient-to-br from-indigo-50/70 to-blue-50/50 border border-indigo-100/60 rounded-2xl p-6 flex items-center gap-5">
          ...
          <p className="text-sm text-slate-600 leading-relaxed">
            <strong className="text-slate-800">Full-time employees</strong> are
            required to serve a{" "}
            <strong className="text-slate-800">30-day notice period</strong>{" "}
            upon submitting their resignation.
          </p>
        </div>
      </div>
      ...
      <div className="bg-slate-50 border border-slate-100 rounded-2xl p-5 space-y-3">
        ...
        <p className="text-sm text-slate-600 leading-relaxed">
          ...
          <strong className="text-slate-800">
            not permitted to take Leave or Work From Home (WFH)
          </strong>{" "}
          during their notice period. If any Leave or WFH is taken, the notice
          period will be{" "}
          <strong className="text-slate-800">
            extended by the corresponding number of days
          </strong>
          .
        </p>
      </div>
      ...
      <div className="bg-amber-50/50 border border-amber-200/60 rounded-2xl p-5 space-y-3">
        ...
        <p className="text-sm text-amber-900/80 leading-relaxed">
          Failure to complete the required notice period will result in{" "}
          <strong>exit documents not being issued</strong>, including the:
        </p>
            ...
            <div className="bg-gradient-to-br from-indigo-50/70 to-blue-50/50 border border-indigo-100/60 rounded-2xl p-6">
              ...
              <div className="text-sm text-slate-600 space-y-3 leading-relaxed">
                <p>
                  ...
                  is an India-based AI and data infrastructure company focused
                  on building solutions for Physical AI, industrial automation,
                  robotics, and high-quality AI data annotation services. The
                  company was incorporated in 2025 and is headquartered in
                  Maharashtra, with operations centered around AI, industrial
                  systems, and data services.
                </p>
                <p>
                  The company provides domain-expert annotation services for
                  high-stakes AI applications, particularly in robotics,
                  manufacturing, automation, and sensor-heavy environments where
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                {focusAreas.map((area, idx) => {
                  ...
                  return (
                    <div
                      key={idx}
                      className="flex items-center gap-3 bg-white border border-slate-200/80 rounded-xl p-3.5 shadow-[0_1px_2px_rgba(0,0,0,0.02)] hover:border-indigo-200 transition-colors"
                    >
              ...
              <ul className="space-y-4 text-sm text-slate-600">
                <li className="flex gap-3">
                  ...
                  <div>
                    <strong className="text-slate-800 block">
                      Add Clear Context Upfront 📝
                    </strong>
                    Don't just drop a link. Mention what it is, why it matters,
                ...
                <li className="flex gap-3">
                  ...
                  <div>
                    ...
                    Hyperlink docs cleanly instead of pasting raw URLs. Use
                    meaningful link text like{" "}
                    <span className="italic text-indigo-600 font-medium">
                      "VIGIL Installation Checklist"
                    </span>
                    .
                  </div>
                </li>
                <li className="flex gap-3">
                  ...
                  <div>
                    ...
                    Avoid tagging large groups unnecessarily; tag owners and
                    action-takers directly.
                  </div>
                </li>
                <li className="flex gap-3">
                  <span className="flex-shrink-0 w-6 h-6 rounded-full bg-emerald-50 text-emerald-600 flex items-center justify-center font-bold text-xs">
                  ...
                  <div>
                    ...
                    Clearly state why the team should care, what has changed, or
                ...
                <li className="flex gap-3">
                  ...
                  <div>
                    ...
                    Use bullets, spacing, and short paragraphs. Large text walls
                    reduce response and reading quality.
                  </div>
                </li>
                <li className="flex gap-3">
                  <span className="flex-shrink-0 w-6 h-6 rounded-full bg-emerald-50 text-emerald-600 flex items-center justify-center font-bold text-xs">
                  ...
                  <div>
                    ...
                    Create quick visual scanning by using intentional status
                    emojis (e.g. 🔴{" "}
                ...
                <li className="flex gap-3">
                  ...
                  <div>
                    <strong className="text-slate-800 block">
                      Clearly Mention Ownership + Timelines ⏳
                    </strong>
                    Provide explicit ownership and delivery timelines (e.g.,{" "}
                    <code className="bg-slate-100 px-1 py-0.5 rounded text-indigo-600 text-xs font-semibold">
                      @User to review by EOD
                    </code>{" "}
                    or{" "}
                    <code className="bg-slate-100 px-1 py-0.5 rounded text-indigo-600 text-xs font-semibold">
                      @User to share inputs tomorrow morning
                    </code>
                    ).
                  </div>
                </li>
                <li className="flex gap-3">
                  ...
                  <div>
                    <strong className="text-slate-800 block">
                      End with Explicit Next Steps or Asks 🏁
                    </strong>
                    Don't leave messages open-ended. Clearly outline
                    action-items (e.g., review, approve, comment, test, deploy).
                  </div>
                </li>
              </ul>
            </div>
          ...
          <div className="space-y-6 animate-in fade-in duration-300">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 mb-6">
                <StatCard
                  title="Annual Paid Leave (APL)"
                  value="12"
                  unit="Days"
                  icon={Calendar}
                  tone="emerald"
                  hint="Granted per calendar year"
                />
                <StatCard
                  ...
                  icon={Sparkles}
                  tone="indigo"
                  hint="Fixed cultural & religious days"
                />
                <StatCard
                  title="Floater Leave"
                  value="2"
                ...
                <StatCard
                  ...
                  icon={TrendingUp}
                  tone="rose"
                  hint="1 day per 20 completed workdays"
                />
              </div>
            </div>
            ...
            <div className="bg-amber-50/50 border border-amber-200/60 rounded-2xl p-5 space-y-3">
              ...
              <ul className="list-disc list-inside text-sm text-amber-900/80 space-y-1.5 pl-1">
                <li>
                  All leave and Work From Home (WFH) requests must be applied
                  and tracked through the <strong>PM Portal</strong>.
                </li>
                <li>
                  Leave shall be considered approved only after{" "}
                  <strong>prior approval</strong> from the reporting manager.
                </li>
                <li>
                  Employees are required to apply for leave{" "}
                  <strong>1 week in advance</strong>, except in cases of
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-2">
              <div className="bg-white border border-slate-200/80 rounded-2xl p-5 shadow-sm space-y-3">
                <h4 className="font-bold text-slate-800 text-sm border-b border-slate-100 pb-2">
                  Leave Policy for Interns & Contractors 🎓
                </h4>
                <ul className="list-disc list-inside text-sm text-slate-600 space-y-1.5">
                  <li>
                    Eligible for <strong>1 Paid Leave per month</strong>{" "}
                    (accrues/resets monthly).
                  </li>
                  <li>
                    Eligible for <strong>0 Casual/Sick Leaves</strong>. Any
                    casual/sick leave taken is unpaid.
                  </li>
                  <li>
                    Eligible for <strong>2 Floater Leaves</strong> overall per
                    year, matching standard employees.
                  </li>
                  <li>
                    Any leave taken exceeding these quotas is treated as unpaid.
                  </li>
                </ul>
              </div>
              <div className="bg-white border border-slate-200/80 rounded-2xl p-5 shadow-sm space-y-3">
                ...
                <ul className="list-disc list-inside text-sm text-slate-600 space-y-1.5">
                  <li>
                    Full-time employees may choose to{" "}
                    <strong>club or combine</strong> their leaves together if
                    required.
                  </li>
                  <li>
                    Employees cannot avail more than{" "}
                    <strong>5 consecutive leaves</strong> at a time without
                    special management approval.
                  </li>
                  <li>
                    Employees are encouraged to utilize leaves responsibly and
                    avoid planning that impacts workflow and team operations.
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="bg-indigo-50/40 border border-indigo-100/60 rounded-2xl p-5 space-y-3">
              <h4 className="font-bold text-indigo-800 text-sm">
                Working Hours & Weekend Support 🕒
              </h4>
              <div className="text-sm text-indigo-900/80 space-y-2.5">
                <p>
                  <strong>Core Working Hours:</strong> Employees are expected to
                  be available between <strong>9:00 AM and 8:00 PM IST</strong>.
                  While continuous online presence throughout these hours is not
                  required, you are expected to remain responsive, attend team
                  calls, and actively collaborate during this window.
                </p>
                <p>
                  <strong>Weekend Contributions:</strong> From time to time, the
                  organization may require support on weekends for business
                  needs. While weekend availability is not mandatory, your
                  willingness to contribute during such times is highly
                  appreciated. Any such contributions will be duly compensated
                  in accordance with company policy.
                </p>
                <p className="text-xs text-indigo-800/70 italic">
                  Proactive participation and flexibility, including occasional
                  weekend contributions, demonstrate ownership and commitment.
                  Such efforts are recognized and contribute positively to
                  individual growth, increased responsibilities, and future
          ...
          <div className="space-y-6 animate-in fade-in duration-300">
            ...
            <div className="bg-slate-50 border border-slate-100 rounded-2xl p-6">
              ...
              <div className="space-y-4 text-sm text-slate-600">
                <div>
                  ...
                  <p>
                    703, Lodha Supremus, Saki Vihar Road, Opposite L&T Gate No.
                    6, Powai, Mumbai 400072
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-slate-400 text-xs mt-0.5">
                    Flexible logging available for engineering and annotation
                    teams.
                  </p>
                </div>
              </div>
              ...
              {wifiLoading ? (
                ...
                <div className="space-y-4">
                  {wifiNetworks.map((network) => (
                    <div
                      key={network.id}
                      className="bg-white rounded-xl border border-blue-100 p-4 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4"
                    >
                      <div>
                ...
                <p className="text-sm text-slate-400 italic">
                  WiFi information has not been configured yet. Please contact
                  your administrator.
                </p>
              )}
            </div>
            ...
            <div className="bg-emerald-50/40 border border-emerald-100/60 rounded-2xl p-6">
              ...
              {generalSettings.company_perks ? (
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {generalSettings.company_perks
                    ...
                    .map((perk, idx) => (
                      <div
                        key={idx}
                        className="flex items-center gap-2.5 bg-white border border-emerald-100 rounded-xl px-4 py-3 text-sm text-slate-700"
                      >
                ...
                <p className="text-sm text-slate-400 italic">
                  Company perks not configured yet.
                </p>
              )}
            </div>
          </div>
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-8 gap-4">
        <div>
          ...
          <p className="text-[13px] text-slate-500 mt-0.5">
            General reference handbook, policies, and guidelines
          </p>
        </div>
      </div>

      {/* Tab Navigation */}
      <div className="inline-flex items-center rounded-lg border border-slate-200 bg-slate-50 p-0.5 w-fit overflow-x-auto max-w-full">
        {tabs.map((tab) => {
          const Icon = tab.icon;
          ...
          return (
            <button
              ...
              className={`flex items-center gap-2 px-3 py-1.5 text-[13px] font-semibold rounded-md transition-all whitespace-nowrap ${
                isActive
