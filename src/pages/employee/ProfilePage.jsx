...
const ProfilePage = () => {
 ...
 <div>
 <h1 className="text-lg font-semibold text-slate-900">{mergedProfile.name || 'Employee'}</h1>
 <p className="text-slate-500 text-[13px] mt-0.5">Your account and work details in one place.</p>
