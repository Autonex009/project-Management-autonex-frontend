...
const EmployeeDashboard = () => {
 ...
 <p className="text-slate-500 text-[13px] mt-0.5">Here&apos;s your work overview for today.</p>
 </div>
 </div>

 {/* KPI Row */}
 <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
 <StatCard icon={FolderKanban} title="Active Projects" value={activeProjects.length} tone="indigo" />
 <StatCard icon={Clock} title="Daily Hours" value={`${totalHours}h`} tone="sky" />
 <StatCard icon={Calendar} title="Upcoming Leaves" value={upcomingLeaves.length} tone="amber" />
 <StatCard
 ...
 <span className="text-sm text-slate-600">{getLeaveTypeLabel(l.leave_type)}</span>
