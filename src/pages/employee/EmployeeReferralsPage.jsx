...
const EmployeeReferralsPage = () => {
 ...
 <StatCard icon={Users2} title="Total Referrals" value={referrals.length} tone="indigo" />
 <StatCard icon={Clock} title="Pending Review" value={pendingCount} tone="amber" />
 <StatCard icon={CheckCircle2} title="Hired" value={hiredCount} tone="emerald" />
 </div>
 )}
