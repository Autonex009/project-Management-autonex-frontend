...
const EmployeeReferralsPage = () => {
  ...
  const createMutation = useMutation({
    ...
    onError: (err) =>
      toast.error(err.response?.data?.detail || "Failed to submit referral"),
  });
  ...
  const deleteMutation = useMutation({
    ...
    onError: (err) =>
      toast.error(err.response?.data?.detail || "Failed to withdraw referral"),
  });
  ...
  const validate = () => {
    ...
    if (!form.candidate_email.trim()) e.candidate_email = "Required";
      ...
      e.candidate_email = "Invalid email";
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-16 text-slate-400">
            ...
            <p className="text-sm mt-1">
              Know someone who'd be a great fit? Refer them!
            </p>
            <Button
              variant="success"
              onClick={() => {
          ...
          <Modal.Body className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="sm:col-span-2">
                ...
                <Dropdown
                  options={[
                    { value: "", label: "How do you know this person?" },
        ...
        <Modal isOpen onClose={() => setDeleteConfirm(null)} size="sm">
          <Modal.Body>
            ...
            <p className="text-sm text-slate-500">
              This will remove your referral for{" "}
              <strong>{deleteConfirm.candidate_name}</strong>. This action
              cannot be undone.
            </p>
          </Modal.Body>
          <Modal.Footer>
            <Button variant="cancel" onClick={() => setDeleteConfirm(null)}>
              Cancel
            </Button>
            <Button
              variant="danger"
