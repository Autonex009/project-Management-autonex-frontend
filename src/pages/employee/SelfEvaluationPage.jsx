...
const SelfEvaluationPage = () => {
 ...
 <div>
 <h1 className="text-lg font-semibold text-slate-900">Monthly Self-Evaluation</h1>
 ...
 <div className="space-y-6">
 <div>
 <h1 className="text-lg font-semibold text-slate-900">Monthly Performance Review</h1>
 <p className="text-slate-500 text-[13px] mt-0.5">
