        ...
        highlights={[
          {
            ...
            copy: "See workstreams, allocations, and progress in one consistent system.",
          },
          {
            title: "Team Direction",
            copy: "Guide your team with clearer structure and better brand presence.",
          },
        ]}
      />
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            >
              {loginMutation.isPending ? (
                <Spinner size="sm" color="white" text="Signing in..." />
              ) : (
                "Sign In"
              )}
            </button>
