  ...
  return (
    <div className="min-h-screen flex">
      <AuthBrandPanel
        ...
        title={theme.title}
        description="Enter your email and we'll send a secure password reset link to your inbox."
        highlights={[
          {
            title: "Email Delivery",
            copy: "Reset links are sent directly to your registered email address.",
          },
          {
            title: "15-Minute Window",
            copy: "Each link is short-lived and invalidated after use.",
          },
        ]}
      />
        ...
        >
          ...
          <div className="mt-6">
            ...
            <p className={`mt-2 text-sm ${theme.helper}`}>
              We’ll look up your account and send a password reset link to your
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-5">
            ...
            >
              {forgotPasswordMutation.isPending ? (
                <Spinner size="sm" color="white" text="Sending reset link..." />
              ) : (
                <>
                  Send reset link
